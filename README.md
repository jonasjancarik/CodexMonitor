...
- Capability-aware model and reasoning grid with benchmark-informed value recommendations, pre-GPT-5.6 models tucked under **Older models**, and a compact Fast speed switch, plus collaboration modes (when enabled), access modes with automatic approval review as the default, and the context usage ring.
