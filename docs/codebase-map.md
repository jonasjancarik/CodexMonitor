...
- Workspace home model picker, page-level portal, and viewport placement: `src/features/workspaces/components/WorkspaceHomeRunControls.tsx`, `src/features/app/hooks/useMenuController.ts`, `src/styles/workspace-home.css`
